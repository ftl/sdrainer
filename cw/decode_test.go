...
func TestDecoder_RecordedStreams(t *testing.T) {
	...
	tt := []struct {
		...
		{filename: "db100fk_3.txt", expected: "i100fk cq db1drfk db 100fk"},
		{filename: "gb4wwa.txt", expected: "rq gb4wwa gb4wwa up"},
		{filename: "ii3wwa.txt", expected: "kde ii3wwa ii3wwa pse k"},
		...
		{filename: "ly2px_4.txt", expected: "q cq cqde ly2px ly2px cqcq cqde ly2px ly2px ly2gx ä"},
	}
